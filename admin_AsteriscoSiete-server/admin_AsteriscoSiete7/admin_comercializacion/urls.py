...
urlpatterns += [
re_path(r'^comercializacion/operadora/crear/$', operadoras_views.OperadorasCreateView.as_view(), name='admin_comercializacion_operadoras_create'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/operadoras/$', operadoras_views.OperadorasListView.as_view(), name='admin_comercializacion_operadoras_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/operadora/(?P<pk>\d+?)/editar/$', operadoras_views.OperadorasUpdateView.as_view(), name='admin_comercializacion_operadoras_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/operadora/(?P<pk>\d+?)/eliminar/$', operadoras_views.OperadorasDeleteView.as_view(), name='admin_comercializacion_operadoras_delete'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/operadora/(?P<pk>\d+?)/$', operadoras_views.OperadorasDetailView.as_view(), name='admin_comercializacion_operadoras_detail'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/bloque/crear/$', bloques_views.BloquesCreateView.as_view(), name='admin_comercializacion_bloques_create'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bloques/$', bloques_views.BloquesListView.as_view(), name='admin_comercializacion_bloques_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bloque/(?P<pk>\d+?)/editar/$', bloques_views.BloquesUpdateView.as_view(), name='admin_comercializacion_bloques_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bloque/(?P<pk>\d+?)/eliminar/$', bloques_views.BloquesDeleteView.as_view(), name='admin_comercializacion_bloques_delete'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bloque/(?P<pk>\d+?)/$', bloques_views.BloquesDetailView.as_view(), name='admin_comercializacion_bloques_detail'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bloque/operadora/$', bloques_views.BloquesListbyOperadoraAjax.as_view(), name='admin_comercializacion_bloques_by_operadora_ajax'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bloque/email/(?P<cache_key>.+?)/$', EmailView, name='admin_comercializacion_bloques_send_email'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bloque/print/(?P<cache_key>.+?)/$', PdfKitView, name='admin_comercializacion_bloques_detail_print'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/banca/crear/$', bancas_views.BancasCreateView.as_view(), name='admin_comercializacion_bancas_create'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bancas/$', bancas_views.BancasListView.as_view(), name='admin_comercializacion_bancas_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/banca/(?P<pk>\d+?)/editar/$', bancas_views.BancasUpdateView.as_view(), name='admin_comercializacion_bancas_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/banca/(?P<pk>\d+?)/eliminar/$', bancas_views.BancasDeleteView.as_view(), name='admin_comercializacion_bancas_delete'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/banca/(?P<pk>\d+?)/$', bancas_views.BancasDetailView.as_view(), name='admin_comercializacion_bancas_detail'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bancas/bloque/$', bancas_views.BancasListbyBloqueAjax.as_view(), name='admin_comercializacion_bancas_by_bloque_ajax'),
]
# ===================================================================#
#     LINKS DATATABLES
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/bancas/bancas_list_datatables/$', bancas_views.BancasDatatableView.as_view(), name='bancas_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/banca/email/(?P<cache_key>.+?)/$', EmailView, name='admin_comercializacion_bancas_send_email'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/banca/print/(?P<cache_key>.+?)/$', PdfKitView, name='admin_comercializacion_bancas_detail_print'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/distribuidor/crear/$', distribuidores_views.DistribuidoresCreateView.as_view(), name='admin_comercializacion_distribuidores_create'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidores/$', distribuidores_views.DistribuidoresListView.as_view(), name='admin_comercializacion_distribuidores_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidor/(?P<pk>\d+?)/editar/$', distribuidores_views.DistribuidoresUpdateView.as_view(), name='admin_comercializacion_distribuidores_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidor/(?P<pk>\d+?)/eliminar/$', distribuidores_views.DistribuidoresDeleteView.as_view(), name='admin_comercializacion_distribuidores_delete'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidor/(?P<pk>\d+?)/$', distribuidores_views.DistribuidoresDetailView.as_view(), name='admin_comercializacion_distribuidores_detail'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidor/bloque/$', distribuidores_views.DistribuidoresListbyBloqueAjax.as_view(), name='admin_comercializacion_distribuidores_by_bloque_ajax'),
]
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidor/banca/$', distribuidores_views.DistribuidoresListbyBancaAjax.as_view(), name='admin_comercializacion_distribuidores_by_banca_ajax'),
]
# ===================================================================#
#     LINKS DATATABLES
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/distribuidores/distribuidores_list_datatables/$', distribuidores_views.DistribuidoresDatatableView.as_view(), name='distribuidores_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidor/email/(?P<cache_key>.+?)/$', EmailView, name='admin_comercializacion_distribuidores_send_email'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidor/print/(?P<cache_key>.+?)/$', PdfKitView, name='admin_comercializacion_distribuidores_detail_print'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/agencia/crear/$', agencias_views.AgenciasCreateView.as_view(), name='admin_comercializacion_agencias_create'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencias/$', agencias_views.AgenciasListView.as_view(), name='admin_comercializacion_agencias_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencia/(?P<pk>\d+?)/editar/$', agencias_views.AgenciasUpdateView.as_view(), name='admin_comercializacion_agencias_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencia/(?P<pk>\d+?)/eliminar/$', agencias_views.AgenciasDeleteView.as_view(), name='admin_comercializacion_agencias_delete'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencia/(?P<pk>\d+?)/$', agencias_views.AgenciasDetailView.as_view(), name='admin_comercializacion_agencias_detail'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencia/bloques/$', agencias_views.AgenciasListbyBloquesAjax.as_view(), name='admin_comercializacion_agencias_by_bloque_ajax'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencia/bancas/$', agencias_views.AgenciasListbyBancasAjax.as_view(), name='admin_comercializacion_agencias_by_banca_ajax'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencia/distribuidores/$', agencias_views.AgenciasListbyDistribuidoresAjax.as_view(), name='admin_comercializacion_agencias_by_distribuidor_ajax'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencia/get/$', agencias_views.AgenciasListAjax.as_view(), name='admin_comercializacion_agencias_get_ajax'),
]
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencias/monitoreo/$', agencias_views.AgenciasMonitorView.as_view(), name='admin_comercializacion_agencias_monitor'),
]
# ===================================================================#
#     LINKS DATATABLES
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/agencias/agencias_list_datatables/$', agencias_views.AgenciasDatatableView.as_view(), name='agencias_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencia/email/(?P<cache_key>.+?)/$', EmailView, name='admin_comercializacion_agencias_send_email'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencia/print/(?P<cache_key>.+?)/$', PdfKitView, name='admin_comercializacion_agencias_detail_print'),
]
...
urlpatterns += [
re_path(r'^comercializacion/taquilla/crear/$', taquillas_views.TaquillasCreateView.as_view(), name='admin_comercializacion_taquillas_create'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/taquillas/$', taquillas_views.TaquillasListView.as_view(), name='admin_comercializacion_taquillas_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/taquilla/(?P<pk>\d+?)/editar/$', taquillas_views.TaquillasUpdateView.as_view(), name='admin_comercializacion_taquillas_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/taquilla/(?P<pk>\d+?)/eliminar/$', taquillas_views.TaquillasDeleteView.as_view(), name='admin_comercializacion_taquillas_delete'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/taquilla/(?P<pk>\d+?)/$', taquillas_views.TaquillasDetailView.as_view(), name='admin_comercializacion_taquillas_detail'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/bloques/preferencias/$', preferencias_views.BloquesPreferenciasListView.as_view(), name='admin_comercializacion_bloques_preferencias_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bancas/preferencias/$', preferencias_views.BancasPreferenciasListView.as_view(), name='admin_comercializacion_bancas_preferencias_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidores/preferencias/$', preferencias_views.DistribuidoresPreferenciasListView.as_view(), name='admin_comercializacion_distribuidores_preferencias_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencias/preferencias/$', preferencias_views.AgenciasPreferenciasListView.as_view(), name='admin_comercializacion_agencias_preferencias_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/(?P<type>\w+?)/preferencias/(?P<pk>\d+?)/$', preferencias_views.PreferencesFormView.as_view(), name='admin_comercializacion_preferencias_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/preferencias/agencias_preferencias_list_datatables/$', preferencias_views.AgenciasPreferenciasDatatableView.as_view(), name='agencias_preferencias_list_datatables'),
]
...
urlpatterns += [
re_path(r'^comercializacion/preferencias/distribuidores_preferencias_list_datatables/$', preferencias_views.DistribuidoresPreferenciasDatatableView.as_view(), name='distribuidores_preferencias_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/preferencias/bancas_preferencias_list_datatables/$', preferencias_views.BancasPreferenciasDatatableView.as_view(), name='bancas_preferencias_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/preferencias/bloques_preferencias_list_datatables/$', preferencias_views.BloquesPreferenciasDatatableView.as_view(), name='bloques_preferencias_list_datatables'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/bloques/porcentajes/$', porcentajes_views.BloquesPorcentajesListView.as_view(), name='admin_comercializacion_bloques_porcentajes_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bancas/porcentajes/$', porcentajes_views.BancasPorcentajesListView.as_view(), name='admin_comercializacion_bancas_porcentajes_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidores/porcentajes/$', porcentajes_views.DistribuidoresPorcentajesListView.as_view(), name='admin_comercializacion_distribuidores_porcentajes_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencias/porcentajes/$', porcentajes_views.AgenciasPorcentajesListView.as_view(), name='admin_comercializacion_agencias_porcentajes_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/(?P<type>\w+?)/porcentajes/(?P<pk>\d+?)/$', porcentajes_views.PorcentajesFormView.as_view(), name='admin_comercializacion_porcentajes_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/porcentajes/agencias_porcentajes_list_datatables/$', porcentajes_views.AgenciasPorcentajesDatatableView.as_view(), name='agencias_porcentajes_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/porcentajes/distribuidores_porcentajes_list_datatables/$', porcentajes_views.DistribuidoresPorcentajesDatatableView.as_view(), name='distribuidores_porcentajes_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/porcentajes/bancas_porcentajes_list_datatables/$', porcentajes_views.BancasPorcentajesDatatableView.as_view(), name='bancas_porcentajes_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/porcentajes/bloques_porcentajes_list_datatables/$', porcentajes_views.BloquesPorcentajesDatatableView.as_view(), name='bloques_porcentajes_list_datatables'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/bloques/cupos/$', cupos_views.BloquesCuposListView.as_view(), name='admin_comercializacion_bloques_cupos_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bancas/cupos/$', cupos_views.BancasCuposListView.as_view(), name='admin_comercializacion_bancas_cupos_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidores/cupos/$', cupos_views.DistribuidoresCuposListView.as_view(), name='admin_comercializacion_distribuidores_cupos_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencias/cupos/$', cupos_views.AgenciasCuposListView.as_view(), name='admin_comercializacion_agencias_cupos_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/cupo/(?P<pk>\d+?)/editar/$', cupos_views.CuposUpdateView.as_view(), name='admin_comercializacion_cupos_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/cupo/(?P<pk>\d+?)/$', cupos_views.CuposDetailView.as_view(), name='admin_comercializacion_cupos_detail'),
]
...
urlpatterns += [
re_path(r'^comercializacion/cupos/agencias_cupos_list_datatables/$', cupos_views.AgenciasCuposDatatableView.as_view(), name='agencias_cupos_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/cupos/distribuidores_cupos_list_datatables/$', cupos_views.DistribuidoresCuposDatatableView.as_view(), name='distribuidores_cupos_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/cupos/bancas_cupos_list_datatables/$', cupos_views.BancasCuposDatatableView.as_view(), name='bancas_cupos_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/cupos/bloques_cupos_list_datatables/$', cupos_views.BloquesCuposDatatableView.as_view(), name='bloques_cupos_list_datatables'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^comercializacion/bloques/factor-riesgo/$', factorriesgo_views.BloquesFactorRiesgoListView.as_view(), name='admin_comercializacion_bloques_factorriesgo_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bancas/factor-riesgo/$', factorriesgo_views.BancasFactorRiesgoListView.as_view(), name='admin_comercializacion_bancas_factorriesgo_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidores/factor-riesgo/$', factorriesgo_views.DistribuidoresFactorRiesgoListView.as_view(), name='admin_comercializacion_distribuidores_factorriesgo_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencias/factor-riesgo/$', factorriesgo_views.AgenciasFactorRiesgoListView.as_view(), name='admin_comercializacion_agencias_factorriesgo_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/factor-riesgo/(?P<pk>\d+?)/editar/$', factorriesgo_views.FactorRiesgoUpdateView.as_view(), name='admin_comercializacion_factorriesgo_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/factor-riesgo/(?P<pk>\d+?)/$', factorriesgo_views.FactorRiesgoDetailView.as_view(), name='admin_comercializacion_factorriesgo_detail'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/factorriesgo/agencias_factorriesgo_list_datatables/$', factorriesgo_views.AgenciasFactorRiesgoDatatableView.as_view(), name='agencias_factorriesgo_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/factorriesgo/distribuidores_factorriesgo_list_datatables/$', factorriesgo_views.DistribuidoresFactorRiesgoDatatableView.as_view(), name='distribuidores_factorriesgo_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/factorriesgo/bancas_factorriesgo_list_datatables/$', factorriesgo_views.BancasFactorRiesgoDatatableView.as_view(), name='bancas_factorriesgo_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/factorriesgo/bloques_factorriesgo_list_datatables/$', factorriesgo_views.BloquesFactorRiesgoDatatableView.as_view(), name='bloques_factorriesgo_list_datatables'),
]
...
urlpatterns += [
re_path(r'^comercializacion/bloques/permisos/ventas/$', permisos_ventas_views.BloquesPermissionsSalesListView.as_view(), name='admin_comercializacion_bloques_permisos_ventas_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/bancas/permisos/ventas/$', permisos_ventas_views.BancasPermissionsSalesListView.as_view(), name='admin_comercializacion_bancas_permisos_ventas_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/distribuidores/permisos/ventas/$', permisos_ventas_views.DistribuidoresPermissionsSalesListView.as_view(), name='admin_comercializacion_distribuidores_permisos_ventas_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/agencias/permisos/ventas/$', permisos_ventas_views.AgenciasPermissionsSalesListView.as_view(), name='admin_comercializacion_agencias_permisos_ventas_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/(?P<type>\w+?)/permisos/ventas/(?P<pk>\d+?)/$', permisos_ventas_views.PermissionsSalesFormView.as_view(), name='admin_comercializacion_permisos_ventas_update'),
]
# ===================================================================#
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/(?P<type>\w+?)/permisos/ventas/restricciones/(?P<pk>\d+?)/$', permisos_ventas_views.PermissionsSalesRestrictionsFormView.as_view(), name='admin_comercializacion_permisos_ventas_restrictions'),
]
# ===================================================================#
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/permisos/ventas-restrictions/ajax/$', permisos_ventas_views.PermissionsSalesRestrictionsAjax.as_view(), name='admin_comercializacion_permisos_ventas_restrictions_ajax'),
]
...
urlpatterns += [
re_path(r'^comercializacion/(?P<type>\w+?)/permisos/ventas/detail/(?P<pk>\d+?)/$', permisos_ventas_views.PermissionsSalesDetailView.as_view(), name='admin_comercializacion_permisos_ventas_detail'),
]
...
urlpatterns += [
re_path(r'^comercializacion/permisos/bloques_permisos_ventas_list_datatables/$', permisos_ventas_views.BloquesPermissionsSalesDatatableView.as_view(), name='bloques_permisos_ventas_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/permisos/bancas_permisos_ventas_list_datatables/$', permisos_ventas_views.BancasPermissionsSalesDatatableView.as_view(), name='bancas_permisos_ventas_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/permisos/distribuidores_permisos_ventas_list_datatables/$', permisos_ventas_views.DistribuidoresPermissionsSalesDatatableView.as_view(), name='distribuidores_permisos_ventas_list_datatables'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/permisos/agencias_permisos_ventas_list_datatables/$', permisos_ventas_views.AgenciasPermissionsSalesDatatableView.as_view(), name='agencias_permisos_ventas_list_datatables'),
]
# =====================================================================#
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^comercializacion/permisos/ventas/ajax/$', permisos_ventas_views.PermisosVentasAjax.as_view(), name='admin_comercializacion_permisos_ventas_ajax'),
]
