...
function IniReset(){
	...
	$("#expandir_encuentros_automaticos").on("click",ExpandirEncuentrosAutomaticos);

	$("#expandir_asignar_grupos").on("click",expandir_asignar_grupos);
}

expandir_encuentros_automaticos_var = 0
expandir_asignar_grupos_var = 0

function closeAlert(){
	$("#dajax_respuesta").html("")
}
...
function ExpandirEncuentrosAutomaticos(){
...
function expandir_asignar_grupos(){
	if(expandir_asignar_grupos_var==0){
		$(".invisible").css({"display":"block"});
		expandir_asignar_grupos_var = 1
	}
	else{
		$(".invisible").css({"display":"none"});
		expandir_asignar_grupos_var=0
    ...
    if( entro == true){
    	...
    	$("#dajax_respuesta").html(''+
    		'<div class="alert alert_info">'+
    			'<div class="side left">'+
            		'<p><i class="icon icon-info"></i><span class="message">'+
            		'Condiciones asociadas con éxito!!!'+
    				'</span></p>'+
            	'</div>'+
            	'<div class="side right">'+
            		'<i class="close icon-cancel-circle close_alert" onclick="closeAlert()"></i>'+
            	'</div>'+
            '</div>');
    }
    else{
    	$("#dajax_respuesta").html(''+
    		'<div class="alert alert_danger">'+
    			'<div class="side left">'+
            		'<p><i class="icon icon-info"></i><span class="message">'+
            		'No hay ninguna condiccion asocciada'+
    				'</span></p>'+
            	'</div>'+
            	'<div class="side right">'+
            		'<i class="close icon-cancel-circle close_alert" onclick="closeAlert()"></i>'+
    ...
    if( entro == true){
    	...
    	$("#dajax_respuesta").html(''+
    		'<div class="alert alert_info">'+
    			'<div class="side left">'+
            		'<p><i class="icon icon-info"></i><span class="message">'+
            		'Modalidades asociadas con éxito!!!'+
    				'</span></p>'+
            	'</div>'+
            	'<div class="side right">'+
            		'<i class="close icon-cancel-circle close_alert" onclick="closeAlert()"></i>'+
    	...
    	$("#dajax_respuesta").html(''+
    		'<div class="alert alert_danger">'+
    			'<div class="side left">'+
            		'<p><i class="icon icon-info"></i><span class="message">'+
            		'No hay ninguna modalidad asocciada'+
    				'</span></p>'+
            	'</div>'+
            	'<div class="side right">'+
            		'<i class="close icon-cancel-circle close_alert" onclick="closeAlert()"></i>'+
...
function Crear_Encuentro(){
	if($("#id_id_equipos_obj_2 option").length<1){
		$("#dajax_respuesta").html(''+
    		'<div class="alert alert_danger">'+
    			'<div class="side left">'+
            		'<p><i class="icon icon-info"></i><span class="message">'+
            		'como minimo se debe seleccionar un equipo'+
    				'</span></p>'+
            	'</div>'+
            	'<div class="side right">'+
            		'<i class="close icon-cancel-circle close_alert" onclick="closeAlert()"></i>'+
    ...
    if( entro == true){
    	...
    	$("#dajax_respuesta").html(''+
    		'<div class="alert alert_danger">'+
    			'<div class="side left">'+
            		'<p><i class="icon icon-info"></i><span class="message">'+
            		'No hay ningun equipos seleccionados'+
    				'</span></p>'+
            	'</div>'+
            	'<div class="side right">'+
            		'<i class="close icon-cancel-circle close_alert" onclick="closeAlert()"></i>'+
...
function add_equipo_2(){
	if($("#id_id_equipos_2 option:selected").val()!=null){
		...
		/*OJO se quito la validacion de maximos equipos a enfrentarse*/
	}
