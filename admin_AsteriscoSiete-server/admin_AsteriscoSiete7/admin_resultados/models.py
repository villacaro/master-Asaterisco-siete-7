...
class ResultadosRestric(models.Model):
    ...
    resultado = models.ForeignKey(
        'admin_resultados.Resultados',  # TODO: revisar modelo destino
        on_delete=models.CASCADE,
    )
...
class AnotacionesDetail(models.Model):
    ...
    anotacion = models.ForeignKey(
        'admin_resultados.Anotaciones',  # TODO: revisar modelo destino
        on_delete=models.CASCADE,
    )

    encuentro_detail = models.ForeignKey(
        'admin_juego.SorteoDetalle',  # TODO: revisar modelo destino
        on_delete=models.CASCADE,
    )
