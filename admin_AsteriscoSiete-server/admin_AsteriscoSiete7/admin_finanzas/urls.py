...
urlpatterns += [
re_path(r'^reportes/comercializadoras/resumen-administrativo/$', resumen_administrativo_views.VentasResumenAdministrativo.as_view(), name='admin_finanzas_resumenadministrativo_general'),
]
if ADD_MENU:
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/resumen-administrativo-personalizado/$', resumen_administrativo_views.VentasResumenAdministrativoPersonalizado.as_view(), name='admin_finanzas_resumenadministrativo_personalizado'),
]
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/resumen-administrativo/csv/(?P<cache_key>.+?)/$', CsvView, name='admin_finanzas_resumenadministrativo_general_print_csv'),
]
# ===================================================================#
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/resumen-administrativo/pdf/(?P<cache_key>.+?)/$', PdfView, name='admin_finanzas_resumenadministrativo_general_print_pdf'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/resumen-administrativo/import/$', resumen_administrativo_views.VentasResumenAdministrativoImport.as_view(), name='admin_finanzas_resumenadministrativo_general_import'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/resumen-administrativo/(?P<comercializadora>\d+?)/$', resumen_administrativo_views.VentasResumenAdministrativoByComercializadora.as_view(), name='admin_finanzas_resumenadministrativo_comercializadora_list'),
]
# ===================================================================#
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/resumen-administrativo/comercializadoras/csv/(?P<cache_key>.+?)/$', CsvView, name='admin_finanzas_resumenadministrativo_comercializadora_print_csv'),
]
# ===================================================================#
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/resumen-administrativo/comercializadoras/pdf/(?P<cache_key>.+?)/$', PdfView, name='admin_finanzas_resumenadministrativo_comercializadora_print_pdf'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/hoja-de-banco/(?P<comercializadora>\d+?)/$', resumen_administrativo_views.VentasHojaDeBancoByComercializadora.as_view(), name='admin_finanzas_resumenadministrativo_hoja_de_banco_list'),
]
# ===================================================================#
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/hoja-de-banco/csv/(?P<cache_key>.+?)/$', CsvView, name='admin_finanzas_resumenadministrativo_hojabanco_print_csv'),
]
# ===================================================================#
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/hoja-de-banco/pdf/(?P<cache_key>.+?)/$', PdfView, name='admin_finanzas_resumenadministrativo_hojabanco_print_pdf'),
]
...
urlpatterns += [
re_path(r'^reportes/comercializadoras/(?P<movimiento>[a-z]+?)/(?P<comercializadora>\d+?)/'
        '(?P<year>[0-9]{4})/(?P<month>[0-9]{2})/(?P<day>[0-9]{2})/$', resumen_administrativo_views.MovimientosForComercializadoraToFecha.as_view(), name='admin_finanzas_resumenadministrativo_movimientos_list'),
]
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/$', cuenta_views.CuentaListView.as_view(), name='admin_finanzas_cuenta_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/(?P<pk>\d+?)/eliminar/$', cuenta_views.CuentaDeleteView.as_view(), name='admin_finanzas_cuenta_delete'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/crear/$', cuenta_views.CuentaCreateView.as_view(), name='admin_finanzas_cuenta_create'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/(?P<pk>\d+?)/$', cuenta_views.CuentaDetailView.as_view(), name='admin_finanzas_cuenta_detail'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/(?P<pk>\d+?)/editar/$', cuenta_views.CuentaUpdateView.as_view(), name='admin_finanzas_cuenta_update'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/movimientos/$', movimientos_views.MovimientosListView.as_view(), name='admin_finanzas_movimiento_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/movimientos/(?P<pk>\d+?)/$', movimientos_views.MovimientosDetailView.as_view(), name='admin_finanzas_movimiento_detail'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/movimiento/(?P<pk>\d+?)/eliminar/$', movimientos_views.MovimientoDeleteView.as_view(), name='admin_finanzas_movimiento_delete'),
]
# ===================================================================#
# Creado permisos para los urls descritos de cuentas
# ===================================================================#
...
urlpatterns += [
re_path(r'^operaciones_financieras/saldo_inicial/$', saldos_views.ComercializadoraListView.as_view(), name='admin_finanzas_saldoinicial_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/saldo_inicial/(?P<pk>\d+?)/reiniciar/$', saldos_views.ComercializadoraResetView.as_view(), name='admin_finanzas_saldoinicial_reset'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/saldo_inicial/(?P<pk>\d+?)/editar/$', saldos_views.ComercializadoraUpdateView.as_view(), name='admin_finanzas_saldoinicial_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/saldo_inicial/registrar/$', saldos_views.ComercializadoraRegisterView.as_view(), name='admin_finanzas_saldoinicial_register'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^operaciones_financieras/fecha_de_trabajo/$', dia_trabajo_views.DiaTrabajoView.as_view(), name='admin_finanzas_diatrabajo_update'),
]
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cerrar_dia/$', dia_trabajo_views.CerrarDiaTrabajoView.as_view(), name='admin_finanzas_diatrabajo_close'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^operaciones_financieras/depositos/$', movimientos_views.MovimientoDepositoView.as_view(), name='admin_finanzas_operaciones_deposito_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/depositos/(?P<comercializadora>\d+?)/$', movimientos_views.MovimientoDepositoView.as_view(), name='admin_finanzas_operaciones_deposito_create'),
]
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/pagos/$', movimientos_views.MovimientoPagoView.as_view(), name='admin_finanzas_operaciones_pago_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/pagos/(?P<comercializadora>\d+?)/$', movimientos_views.MovimientoPagoView.as_view(), name='admin_finanzas_operaciones_pago_create'),
]
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/ajustes/$', movimientos_views.MovimientoAjusteView.as_view(), name='admin_finanzas_operaciones_ajuste_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/ajustes/(?P<comercializadora>\d+?)/$', movimientos_views.MovimientoAjusteView.as_view(), name='admin_finanzas_operaciones_ajuste_create'),
]
# ===================================================================#
...
urlpatterns += [
re_path(r'^operaciones_financieras/configuracion/pagar-cobrar/$', cuentas_operaciones.ConfiguracionPorPagarCobrarView.as_view(), name='admin_finanzas_operaciones_configuracion_pagar_cobrar_list'),
]
# ===================================================================#
if ADD_MENU:
    admin_finanzas_operaciones_deposito = Permissions.register(
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/pagar/$', cuentas_operaciones.CuentasPorPagarView.as_view(), name='admin_finanzas_operaciones_cuentas_pagar_list'),
]
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/cobrar/$', cuentas_operaciones.CuentasPorCobrarView.as_view(), name='admin_finanzas_operaciones_cuentas_cobrar_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/cobrar/csv/(?P<cache_key>.+?)/$', CsvView, name='admin_finanzas_operaciones_cuentas_cobrar_list_print_csv'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/cobrar/pdf/(?P<cache_key>.+?)/$', PdfView, name='admin_finanzas_operaciones_cuentas_cobrar_list_print_pdf'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/pagar/csv/(?P<cache_key>.+?)/$', CsvView, name='admin_finanzas_operaciones_cuentas_pagar_list_print_csv'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^operaciones_financieras/cuentas/pagar/pdf/(?P<cache_key>.+?)/$', PdfView, name='admin_finanzas_operaciones_cuentas_pagar_list_print_pdf'),
]
# ===================================================================#
