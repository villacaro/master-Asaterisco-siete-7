...
class Cuenta(models.Model):
    ...
    def get_absolute_url(self):
        ...
        try:
            return reverse('admin_finanzas_cuenta_detail', kwargs={'pk': self.pk})
...
class Movimiento(models.Model):
    ...
    user = models.ForeignKey(
        'admin_finanzas.Banco',  # TODO: revisar modelo destino
        on_delete=models.CASCADE,
        related_name='movimientos_user',
        null=True, blank=True,
    )
    dia = models.ForeignKey(
        'admin_finanzas.TipoCuenta',  # TODO: revisar modelo destino
        on_delete=models.CASCADE,
    )
    comercializadora = models.ForeignKey(
        'admin_finanzas.Comercializadora',  # TODO: revisar modelo destino
    ...
    tipo = models.ForeignKey(
        'admin_finanzas.TipoMovimiento',  # TODO: revisar modelo destino
        on_delete=models.CASCADE,
    )
    numero = models.CharField(
        max_length=5,
