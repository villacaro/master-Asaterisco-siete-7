...
try:
    ...
    from django.urls import reverse  # noqa (Django <2.0)
from django.db import models

# Constantes de settings con fallback para settings_local
ACTIVATE_HISTORY = getattr(_settings, 'ACTIVATE_HISTORY', True)
FORMAT_STR_DATE_3 = getattr(_settings, 'FORMAT_STR_DATE_3', '%d/%m/%Y %I:%M:%S %p')
REDIS_DB = getattr(_settings, 'REDIS_DB', None)
