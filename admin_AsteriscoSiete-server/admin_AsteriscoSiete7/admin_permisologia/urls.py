...
urlpatterns += [
re_path(r'^permisologia/grupos/crear/$', groups_views.GroupsCreateView.as_view(), name='admin_permisologia_groups_create'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^permisologia/grupos/$', groups_views.GroupsListView.as_view(), name='admin_permisologia_groups_list'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^permisologia/grupo/(?P<pk>\d+?)/editar/$', groups_views.GroupsUpdateView.as_view(), name='admin_permisologia_groups_update'),
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^permisologia/grupo/(?P<pk>\d+?)/eliminar/$', groups_views.GroupsDeleteView.as_view(), name='admin_permisologia_groups_delete')
]
# ===================================================================#
if ADD_MENU:
...
urlpatterns += [
re_path(r'^permisologia/grupo/(?P<pk>\d+?)/$', groups_views.GroupsDetailView.as_view(), name='admin_permisologia_groups_detail')
]
# ===================================================================#
