...
from admin_juego.models import TipoProducto_Grupos, Sorteo
    ...
    def get_queryset(self):
        ...
        if self.get_filter_form().is_valid():
            ...
            if self.get_profile().codename == 'userprofile_master':
                ...
                encuentros = Sorteo.objects.filter(**kwargs_1)
                kwargs_2 = {}
...
class VentaMonitorViewAjax(MonitorVentaView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        encuentro = Sorteo.objects.get(pk=request.GET.get('encuentro'))
        ...
        for deporte_grupo in TipoProducto_Grupos.objects.filter(
            ...
            for modalidad_grupo in modalidades_grupos_list.order_by(
                ...
                encuentros_modalidad = list(SorteoModalidades.objects.filter(
                    encuentro=encuentro,
