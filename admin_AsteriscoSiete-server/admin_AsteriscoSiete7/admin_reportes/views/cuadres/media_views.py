...
from admin_juego.models import (
    TipoProducto, Sorteo, GruposApuesta, apuesta, ModalidadJuego, Fechas,
)
...
class Media(MyViewBase, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.POST.get('orden') == 'comercializacion':
            ...
            if ventas.exists():
                from admin_asterisco7.settings import MESSAGES_GLOBAL
    ...
    def agrupado_deporte(self, ventas):
        ...
        if modalidad:
            ...
            grupo_modalidad = GruposApuesta.objects.get(pk=grupo_modalidad)
            ...
            tipo = 5
            data['verbose_name_hijos'] = 'ModalidadJuego'

        elif encuentro:
            encuentro = Sorteo.objects.get(pk=encuentro)
            ...
            temporada = Fechas.objects.get(pk=temporada)
            ...
            tipo = 3
            data['verbose_name_hijos'] = 'Sorteo'

        elif deporte:
            deporte = TipoProducto.objects.get(pk=deporte)
            ...
            tipo = 1
            data['verbose_name_hijos'] = 'TipoProducto'
