...
from admin_banklotsports.settings import FORMAT_STR_DATE_REPORTS, MESSAGES_GLOBAL
...
from admin_juego.models import Deportes, Encuentros, EncuentrosModalidades, Jugadas, Modalidades, Temporadas
...
class VentasProcesadasProcessView(ReportsBaseView):
    ...
    def get_titles_for_parley(self):
        ...
        if self.modalidad:
            ...
            titles.append({"text": "Encuentros", "width": "30%"})
    ...
    def apply_presentation_for_parley(self):
        ...
        if self.modalidad and self.grupo_modalidad and self.encuentro:
            ...
            encuentro = Encuentros.objects.get(pk=self.encuentro)
