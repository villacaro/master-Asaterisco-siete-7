...
urlpatterns += patterns(
    '',
    url(
        regex=r'^auditoria/usuarios/$',
        view=historic_user_views.HistoricUsersListView.as_view(),
        name='admin_historic_users_list'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^auditoria/usuarios/datatable/$',
        view=historic_user_views.HistoricUsersDatatableView.as_view(),
        name='users_list_datatables'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^auditoria/comercializadoras/filter/$',
        view=filter_views.ComercializadorasListbyProfileAjax.as_view(),
        name='admin_historic_users_list_filter_comer'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^auditoria/usuario/(?P<pk>\d+?)/$',
        view=historic_user_views.HistoricUsersDetailView.as_view(),
        name='admin_historic_users_detail'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^auditoria/usuarios/detalle/datatable/$',
        view=historic_user_views.HistoricUsersDetailDatatableView.as_view(),
        name='users_auditoria_detalle_datatables'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^auditoria/usuario/(?P<pk>\d+?)/(?P<key>\w+?)/$',
        view=historic_views.HistoricUsersDetailDetailView.as_view(),
        name='admin_historic_users_detail_detail'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^auditoria/(?P<app>\w+?)/model/(?P<model>\w+?)/(?P<ref>\w+?)/$',
        view=historic_views.HistoricAppModelRefView.as_view(),
        name='admin_historic_app_model_ref'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^auditoria/(?P<app>\w+?)/model/(?P<model>\w+?)/(?P<ref>\w+?)/(?P<pk>\w+?)/$',
        view=historic_views.HistoricAppModelRefDetailView.as_view(),
        name='admin_historic_app_model_ref_detail'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^auditoria/app_model_list_datatables/$',
        view=historic_views.HistoricAppModelRefDatatableView.as_view(),
        name='app_model_list_datatables'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^account/auditoria/$',
        view=historic_user_views.HistoricAccountDetailView.as_view(),
        name='admin_historic_account_detail'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^account/auditoria/(?P<key>\w+?)/$',
        view=historic_views.HistoricAccountDetailDetailView.as_view(),
        name='admin_historic_account_detail_detail'
    ),
)
# ===================================================================#
