...
from admin_juego.models import Deportes_Grupos, Encuentros, Temporadas
...
class ResultadosPremiarView(MyViewBase, View):
    ...
    def get(self, request, encuentro):
        self.encuentro = get_object_or_404(Encuentros, pk=encuentro)
...
class ResultadosLoadListView(MyViewBase, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if context['object_list']:
            ...
            for temporada in Temporadas.objects.select_related(
