...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/logros/administrar-logros/$',
        view=logros_views.LogrosListView.as_view(),
        name='admin_logros_encuentros_list_edit'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/logro/(?P<pk>\d+?)/asignar/$',
        view=logros_views.LogrosCreateUpdateView.as_view(),
        name='admin_logros_ecuentros_create_update'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/logros/lista/$',
        view=logros_views.LogrosListDetailView.as_view(),
        name='admin_logros_encuentros_list_detail'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/logros/lista/pdf/(?P<cache_key>.+?)/$',
        view=PdfView,
        name='admin_logros_encuentros_detail_imprimir'
    ),
)
"""
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^juego/logros/logros_list_datatables/$',
        view=logros_views.LogrosDatatableView.as_view(),
        name='logros_list_datatables'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/logros/calculadora/$',
        view=calculadora_views.CalculadoraView.as_view(),
        name='admin_logros_calculadora'
    ),
)
