...
urlpatterns += patterns('',
                        url(
                            regex=r'^mail/nuevo/$',
                            view=message_views.MessajeCreateView.as_view(),
                            name='admin_mail_message_create'
                        ),
                        )
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns('',
                        url(
                            regex=r'^mail/recibidos/$',
                            view=message_views.MessajeRecibidosListView.as_view(),
                            name='admin_mail_message_list_recibidos'
                        ),
                        )
urlpatterns += patterns(
    '',
    url(
        regex=r'^mail/recibidos/datatables/$',
        view=message_views.MessajeRecibidosListDatatableView.as_view(),
        name='admin_mail_message_list_recibidos_datatables'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns('',
                        url(
                            regex=r'^mail/enviados/$',
                            view=message_views.MessajeEnviadosListView.as_view(),
                            name='admin_mail_message_list'
                        ),
                        )
urlpatterns += patterns(
    '',
    url(
        regex=r'^mail/enviados/datatables/$',
        view=message_views.MessajeEnviadosListDatatableView.as_view(),
        name='admin_mail_message_list_enviados_datatables'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns('',
                        url(
                            regex=r'^mail/archivados/$',
                            view=message_views.MessajeArchivadosListView.as_view(),
                            name='admin_mail_message_list_archivados'
                        ),
                        )
urlpatterns += patterns(
    '',
    url(
        regex=r'^mail/archivados/datatables/$',
        view=message_views.MessajeArchivadosListDatatableView.as_view(),
        name='admin_mail_message_list_archivados_datatables'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns('',
                        url(
                            regex=r'^mail/papelera/$',
                            view=message_views.MessajePapeleraListView.as_view(),
                            name='admin_mail_message_list_papelera'
                        ),
                        )
urlpatterns += patterns(
    '',
    url(
        regex=r'^mail/papelera/datatables/$',
        view=message_views.MessajePapeleraListDatatableView.as_view(),
        name='admin_mail_message_list_papelera_datatables'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns('',
                        url(
                            regex=r'^mail/eliminar/$',
                            view=message_views.MessajeDeleteView.as_view(),
                            name='admin_mail_message_delete'
                        ),
                        )
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns('',
                        url(
                            regex=r'^mail/(?P<pk>\d+?)/$',
                            view=message_views.MessajeDetailView.as_view(),
                            name='admin_mail_message_detail'
                        ),
                        )
# ===================================================================#
