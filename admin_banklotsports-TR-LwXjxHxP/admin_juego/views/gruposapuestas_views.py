...
from admin_juego.models import Deportes_Grupos, GruposApuestas, RestriccionesReferencias
...
class RestriccionesReferenciasGrupoView(MyViewBase, TemplateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        """
        try:
            self.object = GruposApuestas.objects.get(pk=kwargs["pk"])
        except GruposApuestas.DoesNotExist:
            raise Http404
...
class GruposListbyDeporteAjax(View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        grupos = GruposApuestas.objects.filter(
