...
class AgenciaDataDefault(models.Model):
    ...
    parley_empates_max = models.IntegerField(
        verbose_name='Parley: Cantidad máxima de apuesta a empate por ticket',
        help_text='Parley: Indique la cantidad máxima permitida de apuestas a empate en un ticket'
    )
...
class TaquillaDataDefault(models.Model):
    ...
    passwd = models.CharField(
        ...
        help_text='Ingrese la contraseña por defecto para las taquillas'
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        editable=False,
...
class DataDefault(models.Model):
    ...
    user_type = models.OneToOneField(
        ...
        verbose_name='Tipo de comercializadora (*)',
        help_text='Seleccione el tipo de comercializadora a la cual pertenece la data'
    )
...
class BaseModelCadena(ProtectDelete, models.Model):
    ...
    Campos definidos:
        ...
        resumen_automatic(booleano): indica si el resumen administrativo
            se gestionan de forma automática.
    ...
    resumen_automatic = models.BooleanField(
        default=False,
        verbose_name='Cierre administrativo Automático',
        help_text='Seleccione este campo solo si desea que el resumen administrativo se'
                  ' gestione de forma automática, importacion de saldos y cierre de dias.'
    )
    telefono = models.CharField(
        max_length=12,
        verbose_name='Número Telefónico ',
        help_text='Ingrese el número telefónico',
        null=True,
        blank=True
    )
    ...
    status = models.ForeignKey(
        ...
        help_text='Seleccione el estatus deseado'
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        editable=False,
...
class BaseGenericProcess(models.Model):
    ...
    def get_absolute_url(self):
        return (
            'admin_comercializacion_{0}_detail'.format(self.get_class_name()),
            (),
            {'pk': self.pk}
        )
    ...
    def get_restrictions_modalidades(self):
        ...
        comercializadora = self.get_comercializadora()
        deportes = Deportes.objects.all().values_list('id', flat=True)
...
class Master(object):
    """Master: Este es el papá de los helados :)
...
class BaseGenericModeloJuego(models.Model):
    ...
    Campos definidos:
        ...
        is_logros(booleano): bandera que me indica si administa logros (agrega o edita),
            partiendo de encuentros base, cargados por el dueño del sistema principal

        is_resultados(booleano): bandera que me indica si administa resultados, partiendo
            de encuentros base, cargados por el dueño del sistema principal
    ...
    is_sistema_juego = models.BooleanField(
        default=False,
        verbose_name='¿Administra su propio sistema de juego? ',
    ...
    is_logros = models.BooleanField(
        default=False,
        verbose_name='¿Administra sus propios logros? ',
    ...
    is_resultados = models.BooleanField(
        default=False,
        verbose_name='¿Administra sus propios resultados? ',
    ...
    permissions_create_user = models.BooleanField(
        default=False,
        verbose_name='¿Tiene permisos de crear usuarios de su mismo nivel? ',
    ...
    def save_sistema_juego(self):
        ...
        sistema.is_logros = self.is_logros
...
class Bancas(BaseGenericProcess, BaseModelCadena, BaseGenericModeloJuego):
    ...
    bloque = models.ForeignKey(
        ...
        blank=True,
        verbose_name='Multi Banca (*)',
        help_text='Seleccione una multi banca'
    )
...
class Distribuidores(BaseGenericProcess, BaseModelCadena):
    ...
    banca = models.ForeignKey(
        ...
        blank=True,
        verbose_name='Banca (*)',
        help_text='Seleccione una banca'
    )
...
class Agencias(BaseGenericProcess, BaseModelCadena):
    ...
    distribuidores = models.ForeignKey(
        ...
        blank=True,
        verbose_name='Distribuidor (*)',
        help_text='Seleccione una distribuidor'
    )
    num_taquillas = models.IntegerField(
        verbose_name='Número de taquillas (*)',
        help_text='Seleccione el numero de taquillas a crear automáticamente para la agencia'
    )
    codigo = models.CharField(
        ...
        max_length=30,
        verbose_name='Código ',
        help_text='Introduzca un código de centro de apuesta',
        db_index=True,
    )
    ##
    montomin = models.DecimalField(
        ...
        max_digits=15,
        decimal_places=2,
        verbose_name='Monto mínimo de apuesta ',
        help_text='Seleccione el monto mínimo de apuesta'
    )
    montomax = models.DecimalField(
        null=True,
        max_digits=15,
        decimal_places=2,
        verbose_name='Monto máximo de apuesta ',
        help_text='Seleccione el monto máximo de apuesta'
    )
    montomax_ganancia = models.DecimalField(
        null=True,
        max_digits=15,
        decimal_places=2,
        verbose_name='Monto máximo de ganancia ',
        help_text='Seleccione el monto máximo de ganancia'
    )
    cantidad_apuesta_max = models.IntegerField(
        null=True,
        verbose_name='Cantidad máxima de combinaciones ',
        help_text='Seleccione la cantidad máxima de combinaciones'
    )
    cantidad_apuesta_min = models.IntegerField(
        null=True,
    ...
    tiempoexpiracion = models.IntegerField(
        null=True,
        verbose_name='Días de expiración del los tickets ',
        help_text='Seleccione la cantidad de días de expiración para los tickets'
    )
    parley_machos_max = models.IntegerField(
        null=True,
        verbose_name='Parley: Máximo de apuestas a un macho por ticket',
        help_text='Parley: Seleccione el numero máximo de apuesta a un macho en un ticket'
    )
    parley_machos_min = models.IntegerField(
        null=True,
        verbose_name='Parley: Mínimo de apuestas a un macho por ticket',
        help_text='Parley: Seleccione el numero mínimo de apuesta a un macho en un ticket'
    )
    parley_hembras_max = models.IntegerField(
        null=True,
        verbose_name='Parley: Máximo de apuestas a una hembra por ticket',
        help_text='Parley: Seleccione el numero máximo de apuesta a una en un ticket'
    )
    parley_hembras_min = models.IntegerField(
        null=True,
        verbose_name='Parley: Mínimo de apuestas a un hembra por ticket',
        help_text='Parley: Seleccione el numero mínimo de apuesta a una hembra en un ticket'
    )
    parley_hembras_min = models.IntegerField(
        null=True,
        verbose_name='Parley: cantidad minima de hembras (*)',
    ...
    parley_clonados_maxima_ganancia = models.DecimalField(
        ...
        max_digits=15,
        decimal_places=2,
        verbose_name='Parley: Monto máximo de ganancia para combinaciones repetidas en tickets',
        help_text='Parley: Seleccione el monto máximo para la ganancia de apuestas con '
...
class Taquillas(ProtectDelete, BaseGenericProcess, models.Model):
    ...
    agencia = models.ForeignKey(
        ...
        help_text='Seleccione una agencia'
    )
    monto_alquiler = models.DecimalField(
        max_digits=15,
        decimal_places=5,
    ...
    modo_alquiler = models.BooleanField(
        default=False,
        verbose_name='¿Modo de alquiler activo? ',
    ...
    @models.permalink
    def get_absolute_url(self):
        return ('admin_comercializacion_taquillas_detail', (), {'pk': self.pk})
...
class UsuariosTaquilla(ProtectDelete, AbstractBaseUser):
    ...
    taquilla = models.OneToOneField(
        'Taquillas',
        verbose_name='Taquilla (*)',
        help_text='Ingrese la taquilla '
    )
    status = models.ForeignKey(
        'admin_status.Status',
        verbose_name='Estatus (*)',
...
class Cupos(ProtectDelete, models.Model):
    ...
    operadora = models.ForeignKey(
        ...
        blank=True,
        verbose_name='Operadora ',
        help_text='Seleccione la operadora'
    )
    bloque = models.ForeignKey(
        'Bloques',
        null=True,
        blank=True,
        verbose_name='Bloque ',
        help_text='Seleccione el bloque'
    )
    banca = models.ForeignKey(
        'Bancas',
        null=True,
    ...
    distribuidor = models.ForeignKey(
        ...
        blank=True,
        verbose_name='Distribuidor ',
        help_text='Seleccione el distribuidor'
    )
    agencia = models.ForeignKey(
        'Agencias',
        null=True,
        blank=True,
        verbose_name='Agencia ',
        help_text='Seleccione la agencia'
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        editable=False,
    ...
    @models.permalink
    def get_absolute_url(self):
        return ('admin_comercializacion_cupos_detail', (), {'pk': self.pk})
...
class Porcentajes(ProtectDelete, models.Model):
    ...
    porcentaje_maximo = models.DecimalField(
        max_digits=15,
        decimal_places=4,
        verbose_name='Porcentaje máximo ',
    )
    ...
    @models.permalink
    def get_absolute_url(self):
        return ('admin_comercializacion_porcentajes_detail',
                (), {'pk': self.pk})
...
types_notification = {
    'data_type_origin': {
        ...
        'jornada': (3, 'Jornadas'),
        'encuentro': (4, 'Encuentros'),
        'encuentro_modalidad': (5, 'Referencias'),
        'jugada': (6, 'Logros'),
        'grupos_juego': (7, 'Grupos de juego'),
        'deporte_grupo': (8, 'Deportes Grupos'),
        'grupo_modalidad': (9, 'Grupos Modalidades'),
    },
}
...
class TypePreferences(models.Model):
    ...
    group = models.ForeignKey(
        'GroupPreferences',
        verbose_name='Grupo de preferencia (*)',
        help_text='Seleccione el grupo de preferencia'
    )
...
class DefaultPreferences(models.Model):
    ...
    typepreference = models.ForeignKey(
        'TypePreferences',
        verbose_name='Tipo de preferencia (*)',
        help_text='Seleccione el tipo de preferencia'
    )
