...
urlpatterns += patterns(
    '',
    url(
        regex=r'^usuario/crear/$',
        view=users_views.UsersCreateView.as_view(),
        name='admin_users_users_create'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^usuario/(?P<pk>\d+?)/editar/$',
        view=users_views.UsersUpdateView.as_view(),
        name='admin_users_users_update'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^usuario/(?P<pk>\d+?)/personalizar/$',
        view=users_views.UsersCustomizeView.as_view(),
        name='admin_users_users_customize'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^usuario/(?P<pk>\d+?)/editar/password/$',
        view=users_views.UsersUpdatePasswordView.as_view(),
        name='admin_users_users_update_password'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^usuario/(?P<pk>\d+?)/eliminar/$',
        view=users_views.UsersDeleteView.as_view(),
        name='admin_users_users_delete'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^usuario/(?P<pk>\d+?)/$',
        view=users_views.UsersDetailView.as_view(),
        name='admin_users_users_detail'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^usuarios/userslist_list_datatables/$',
        view=users_views.UsersDatatableView.as_view(),
        name='userslist_list_datatables'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^usuarios/comercializacion_list_by_user_ajax/$',
        view=filters_views.ComercializadorasListbyProfileAjax.as_view(),
        name='admin_users_comercializacion_list_by_user_ajax'
    ),
)
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^account/password_change/$',
        view=users_views.UsersChangePasswordView.as_view(),
        name='admin_users_users_password_change'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    ...
    url(
        regex=r'^account/$',
        view=users_views.UsersAccountView.as_view(),
        name='admin_users_users_account'
    ),
)
# ===================================================================#
