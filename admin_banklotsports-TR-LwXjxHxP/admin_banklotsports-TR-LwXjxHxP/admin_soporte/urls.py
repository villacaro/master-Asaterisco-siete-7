...
urlpatterns += patterns(
    '',
    url(
        regex=r'^soporte/tickets/gestion/$',
        view=tickests_views.BuscarTicket.as_view(),
        name='admin_soporte_BuscarTicket_url'
    ),
)
"""
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^soporte/tickets/gestion/(?P<pk>\d+?)/$',
        view=tickests_views.DetalleTicket.as_view(),
        name='admin_soporte_DetalleTicket_url'
    ),
)
"""
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^soporte/tickets/listado/$',
        view=ListadoGeneralTickets.ListadoTickets.as_view(),
        name='admin_soporte_tickets_list_view_url'
    ),
)
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^soporte/tickets/listado/get/$',
        view=ListadoGeneralTickets.ListadoTicketsAjax.as_view(),
        name='admin_soporte_tickets_list_ajax_url'
    ),
)
"""
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^soporte/sistema/opciones/$',
        view=sistema_views.OptionsSystem.as_view(),
        name='admin_soporte_sistema_opciones'
    ),
)
"""
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^soporte/comercializacion/restaurar/$',
        view=comercializadoras_views.OptionsRestore.as_view(),
        name='admin_soporte_comercializacion_opciones_restaurar'
    ),
)
"""
# ===================================================================#
