...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/ventas-en-linea/$',
        view=ventas_en_linea_views.VentaEnLineaAgrupadaView.as_view(),
        name='admin_reportes_ventas_en_linea_list'
    ),
)
# =============================================================================#
# DATATABLE#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/venta-linea-datatable/$',
        view=ventas_en_linea_views.VentasLineaDatatableView.as_view(),
        name='admin_reportes_venta_en_linea_list_datatable'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/ventas-en-linea/pdf/(?P<cache_key>.+?)/$',
        view=PdfView,
        name='admin_reportes_venta_en_linea_print_pdf'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/ventas-en-linea/csv/(?P<cache_key>.+?)/$',
        view=CsvView,
        name='admin_reportes_venta_en_linea_print_csv'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/juegos/$',
        view=ventas_por_Juegos_views.VentasPorJuegos.as_view(),
        name='admin_reportes_ventas_por_juegos_list'
    ),
)
# ===================================================================#
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/juegos/pdf/(?P<cache_key>.+?)/$',
        view=PdfView,
        name='admin_reportes_venta_por_juegos_print_pdf'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/juegos/csv/(?P<cache_key>.+?)/$',
        view=CsvView,
        name='admin_reportes_venta_por_juegos_print_csv'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/venta-procesadas/$',
        view=ventas_procesadas_views.VentasProcesadas.as_view(),
        name='admin_reportes_ventas_procesadas_list'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/venta-procesadas-datatable/$',
        view=ventas_procesadas_views.VentasProcesadasDatatableView.as_view(),
        name='admin_reportes_ventas_procesadas_list_datatable'
    ),
)
# ===================================================================#
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/ventas-procesadas/csv/(?P<cache_key>.+?)/$',
        view=CsvView,
        name='admin_reportes_venta_procesadas_print_csv'
    ),
)
# ===================================================================#
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/ventas-procesadas/pdf/(?P<cache_key>.+?)/$',
        view=PdfView,
        name='admin_reportes_venta_procesadas_print_pdf'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/ventas-monitor/ajax$',
        view=ventas_monitor_views.VentaMonitorViewAjax.as_view(),
        name='admin_reportes_ventas_monitor_ajax'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/monitor-ventas/$',
        view=ventas_monitor_views.MonitorVentaView.as_view(),
        name='admin_reportes_monitor_ventas_list'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/ventas_monitor_list_datatables/$',
        view=ventas_monitor_views.MonitorDatatableView.as_view(),
        name='ventas_monitor_list_datatables'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-nivel-superior/$',
        view=cuadre_nivel_superior_views.CuadreNivelSuperior.as_view(),
        name='admin_reportes_cuadre_nivel_superior_list'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-queda/fechas/$',
        view=cuadre_por_fechas_queda_views.CuadrePorFechasQueda.as_view(),
        name='admin_reportes_cuadre_por_fechas_queda_list'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-queda/general/$',
        view=cuadre_general_queda_views.CuadreGeneralQueda.as_view(),
        name='admin_reportes_cuadre_general_queda_list'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-parley/$',
        view=cuadre_parley_views.CuadreParley.as_view(),
        name='admin_reportes_cuadre_parley_list'
    ),
)
# =============================================================================#
# DATATABLE#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-parley-datatable/$',
        view=cuadre_parley_views.CuadreParleyDatatableView.as_view(),
        name='admin_reportes_cuadre_parley_list_datatable'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-parley/pdf/(?P<cache_key>.+?)/$',
        view=PdfView,
        name='admin_reportes_cuadre_parley_print_pdf'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-parley/csv/(?P<cache_key>.+?)/$',
        view=CsvView,
        name='admin_reportes_cuadre_parley_print_csv'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/media/$',
        view=media_views.Media.as_view(),
        name='admin_reportes_media_list'
    ),
)
# ===================================================================#
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-queda/general/csv/(?P<cache_key>.+?)/$',
        view=CsvView,
        name='admin_reportes_cuadre_general_queda_print_csv'
    ),
)
# ===================================================================#
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-queda/general/pdf/(?P<cache_key>.+?)/$',
        view=PdfView,
        name='admin_reportes_cuadre_general_queda_print_pdf'
    ),
)
# ===================================================================#
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-queda/fechas/csv/(?P<cache_key>.+?)/$',
        view=CsvView,
        name='admin_reportes_cuadre_por_fechas_queda_print_csv'
    ),
)
# ===================================================================#
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-queda/fechas/pdf/(?P<cache_key>.+?)/$',
        view=PdfView,
        name='admin_reportes_cuadre_por_fechas_queda_print_pdf'
    ),
)
# ===================================================================#
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-nivel-superior/csv/(?P<cache_key>.+?)/$',
        view=CsvView,
        name='admin_reportes_cuadre_de_nivel_superior_print_csv'
    ),
)
# ===================================================================#
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/ventas/cuadre-nivel-superior/pdf/(?P<cache_key>.+?)/$',
        view=PdfView,
        name='admin_reportes_cuadre_de_nivel_superior_print_pdf'
    ),
)
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/tickets/listado-tickets/$',
        view=ListadoGeneralTickets.ListadoTickets.as_view(),
        name='admin_reportes_tickets_list'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/tickets/listado-tickets/get/$',
        view=ListadoGeneralTickets.ListadoTicketsAjax.as_view(),
        name='admin_reportes_tickets_get'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/tickets/listado-tickets/(?P<pk>\d+?)/$',
        view=ListadoDetailTickets.VentasDetalleTickets.as_view(),
        name='admin_reportes_tickets_detail'
    ),
)
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^reportes/tickets/listado-tickets/(?P<estatus>[a-z]+?)/$',
        view=TicketsPorEstatusList.ListadoTicketsEstatus.as_view(),
        name='admin_reportes_tickets_status_list'
    ),
)
# ===================================================================#
