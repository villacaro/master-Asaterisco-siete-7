...
from admin_banklotsports.settings import FORMAT_STR_DATE_REPORTS, REDIS_DB
...
from admin_juego.models import Encuentros, Jornadas, Jugadas, Temporadas
...
class AsyncSuspenderEncuentro(AsyncGestionOperationalError):
    ...
    def run_try(self, *args, **kwargs):
        encuentro = Encuentros.objects.get(pk=kwargs.get('encuentro'))
        jugadas_count = 0
        ...
        return '{0} Jugadas'.format(jugadas_count)
...
class AsyncSuspenderJornada(AsyncGestionOperationalError):
    ...
    def run_try(self, *args, **kwargs):
        jornada = Jornadas.objects.get(pk=kwargs.get('jornada'))
...
class AsyncSuspenderTemporada(AsyncGestionOperationalError):
    ...
    def run_try(self, *args, **kwargs):
        temporada = Temporadas.objects.get(pk=kwargs.get('temporada'))
        ...
        return '{0} Jornadas'.format(jornadas.count())
...
class AsyncGestionDeTicketsPorJugada(AsyncGestionOperationalError):
    ...
    def run_try(self, *args, **kwargs):
        ...
        jugada = Jugadas.objects.get(pk=kwargs.get('jugada'))
