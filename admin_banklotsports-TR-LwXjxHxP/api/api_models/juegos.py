...
from admin_juego.models import (
    Encuentros, EncuentrosDetail, EncuentrosModalidades, Equipos, EquiposTemporadas, GruposJuego, Jornadas, Jugadas,
    Jugador, JugadorTipo, Temporadas, Torneos,
)
