...
def MigrateDataAll(apps, schema_editor):
    from admin_comercializacion.models import GroupPreferences, TypePreferences, \
        DefaultPreferences, Preferences, Agencias
    ...
    print('Preferencias a procesar de la tabla PreferenciasCadena {0}'.format(
        len(preferencesArray)))
    ...
    for agencia in agencias:
        ...
        if agencia.montomax != float(agencia.distribuidores
                                     .get_preference_value_by_codename('preference_amount_max')):
            preference = Preferences(
        ...
        if agencia.montomax_ganancia != float(agencia.distribuidores
                                              .get_preference_value_by_codename('preference_amount_price_max')):
            preference = Preferences(
        ...
        if agencia.parley_clonados_maxima_ganancia != float(agencia.distribuidores
                                                            .get_preference_value_by_codename('preference_amount_price_clone_max')):
            preference = Preferences(
            ...
            preferencesArray.append(preference)
        #######################################################################
        if agencia.cantidad_apuesta_min != int(float(agencia.distribuidores
        ...
        if agencia.cantidad_apuesta_max != int(float(agencia.distribuidores
        ...
        if agencia.parley_machos_min != int(float(agencia.distribuidores
                                                  .get_preference_value_by_codename('preference_quantity_combinations_male_min'))):
            preference = Preferences(
        ...
        if agencia.parley_machos_max != int(float(agencia.distribuidores
                                                  .get_preference_value_by_codename('preference_quantity_combinations_male_max'))):
            preference = Preferences(
        ...
        if agencia.parley_hembras_min != int(float(agencia.distribuidores
                                                   .get_preference_value_by_codename('preference_quantity_combinations_female_min'))):
            preference = Preferences(
        ...
        if agencia.parley_hembras_max != int(float(agencia.distribuidores
                                                   .get_preference_value_by_codename('preference_quantity_combinations_female_max'))):
            preference = Preferences(
        ...
        if agencia.parley_empates_max != int(float(agencia.distribuidores
                                                   .get_preference_value_by_codename('preference_quantity_combinations_draw_max'))):
            preference = Preferences(
        ...
        if agencia.tiempoexpiracion != int(float(agencia.distribuidores
    ...
    print('Preferencias a procesar de la tabla Agencias {0}'.format(
        len(preferencesArray)))
    Preferences.objects.bulk_create(
        preferencesArray
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('admin_comercializacion', '0063_auto_20151109_1004'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='heredity',
            field=models.BooleanField(default=False, verbose_name='¿Hereditaria? ', help_text='Seleccione si es una preferencia heredada'),
        ),
