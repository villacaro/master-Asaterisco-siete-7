...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/resultados/administrar-resultados/$',
        view=resultados_views.ResultadosEncuentrosListView.as_view(),
        name='admin_resultados_encuentros_resultados_list_edit'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/resultados/(?P<encuentro>\d+?)/premiar/$',
        view=resultados_views.ResultadosPremiarView.as_view(),
        name='admin_resultados_premiar_edit'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/resultado/(?P<pk>\d+?)/asignar/$',
        view=resultados_views.ResultadosCreateUpdateView.as_view(),
        name='admin_resultados_ecuentros_resultados_create_update'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/resultado/(?P<pk>\d+?)/change/$',
        view=resultados_views.ResultadosChangeView.as_view(),
        name='admin_resultados_resultados_change'
    ),
)
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/resultados/lista/$',
        view=resultados_views.ResultadosLoadListView.as_view(),
        name='admin_resultados_encuentros_resultados_list_detail'
    ),
)
# ===================================================================#
if ADD_MENU:
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^parley/resultados/lista/pdf/(?P<cache_key>.+?)/$',
        view=PdfView,
        name='admin_resultados_encuentros_resultados_detail_imprimir'
    ),
)
"""
# ===================================================================#
...
urlpatterns += patterns(
    '',
    url(
        regex=r'^juego/resultados/resultados_list_datatables/$',
        view=resultados_views.ResultadosDatatableView.as_view(),
        name='resultados_list_datatables'
    ),
)
# ===================================================================#
