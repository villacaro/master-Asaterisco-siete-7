...
from admin_juego.models import Condiciones, Deportes, Deportes_Grupos, Encuentros, Jugadas
...
class EncuentrosResultadosListForm(WidgetCustomizeForms, forms.Form):
    ...
    deporte = forms.ModelChoiceField(
        queryset=Deportes.objects.only('pk', 'nombre').all().order_by('nombre'),
        required=True,
