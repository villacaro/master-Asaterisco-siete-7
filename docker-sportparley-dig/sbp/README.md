# Sbp - contenedores para produccion instalados por el momento en el mismo servidor de donweb
...
Los siguientes contenedores son levantados por docker-compose, con el prefijo sbp
...
Debe existir un archivo llamado: env que se ignora por git, con las configuraciones necesarias para el servidor de sbp.
...
. Entrar a la carpeta docker/sbp

. Hacer git pull

. Entrar a la carpeta docker/docker-sportparley/sbp

. Hacer `docker ps | grep sbp` para listar solo los contenedores correspondientes
